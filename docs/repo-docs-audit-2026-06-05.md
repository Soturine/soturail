...
- planning parents: `docs/future-rails-index.md`, `docs/ecosystem-influences.md`, `docs/external-projects-audit.md`;
...
- QA/eval/golden checks are covered by `docs/agent-qa-rail.md`, `docs/eval-datasets.md`, `docs/golden-agent-tests.md` and `docs/llm-as-judge-policy.md`.
- Validate/fix/verify/report pipeline ideas are covered by `docs/observability-rail.md`, `docs/workflow-rail.md` and `examples/workflows/agent-pipeline-workflow.md`.
- OpenTracy-style trace, ledger, boundary, experiments and approval ideas are covered by `docs/agent-governance-rail.md`.
- Harness engineering lifecycle is covered by `docs/harness-lifecycle-rail.md` and linked from `docs/harness-rail.md` and `docs/workflow-rail.md`.
- ECC-style host/profile/doctor/audit/skills ideas are covered across `docs/future-rails-index.md`, `docs/host-compatibility-rail.md`, `docs/agent-hosts.md` and `docs/skill-rail-2.md`.
- Feynman-style provenance is covered by `docs/evidence-provenance-rail.md` and linked from Report and Workflow docs.
- book-to-skill-style document-to-skill packs are covered by `docs/knowledge-rail.md`, `docs/context-packs.md` and `docs/skill-rail-2.md`.
- Tasklet ideas are covered by `docs/tasklet-rail.md` and linked from Context/Workflow/Skill planning docs.
- 9Router ideas are safely mapped to `docs/host-router-rail.md`, without proxy, MITM, quota bypass or credential-routing scope.
