...
export async function runV1Readiness(root = process.cwd(), options: SchemaReadinessOptions = {}): Promise<{ report: V1ReadinessReport; jsonPath: string; markdownPath: string; output: string }> {
  ...
  const checks = [
    ...
    docsExist(resolvedRoot, "docs/reference/commands/status-command.md"),
    docsExist(resolvedRoot, "docs/rails/evidence/report-rail.md"),
    docsExist(resolvedRoot, "docs/architecture/dashboard-rail.md"),
    docsExist(resolvedRoot, "docs/reference/commands/stable-command-surface.md"),
    docsExist(resolvedRoot, "docs/reference/contracts/deprecation-policy.md"),
    docsExist(resolvedRoot, "docs/getting-started/migration-v1.md"),
    docsExist(resolvedRoot, "docs/getting-started/quickstart.md", options.strict === true),
    docsExist(resolvedRoot, "docs/reference/contracts/v1-contract.md", options.strict === true),
    docsExist(resolvedRoot, "docs/reference/schemas/schema-contracts.md", options.strict === true),
    docsExist(resolvedRoot, "docs/rails/hosts/agent-hosts.md", options.strict === true),
    docsExist(resolvedRoot, "docs/reference/schemas/host-matrix-schema.md", options.strict === true),
    docsExist(resolvedRoot, "docs/reference/contracts/agent-export-contract.md", options.strict === true),
    docsExist(resolvedRoot, "docs/rails/hosts/mcp-host-manifest.md", options.strict === true),
    docsExist(resolvedRoot, "docs/architecture/clean-code-guidelines.md", options.strict === true),
    docsExist(resolvedRoot, "docs/architecture/architecture-boundaries.md", options.strict === true),
